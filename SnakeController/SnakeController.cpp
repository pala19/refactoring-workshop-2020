...
;
    ...
    if (w == 'W' and f == 'F' and s == 'S') {
        ...
        map.setFoodPosition(foodX, foodY);
...
void Controller::sendPlaceNewFood(int x, int y)
{
    ...
    placeNewFood.x = map.getFoodPositionX();
    placeNewFood.y = map.getFoodPositionY();
...
void Controller::sendClearOldFood()
{
    ...
    clearOldFood.x = map.getFoodPositionX();
    clearOldFood.y = map.getFoodPositionY();
...
{
    if (std::make_pair(newHead.x, newHead.y) == map.getFoodPosition()) {
